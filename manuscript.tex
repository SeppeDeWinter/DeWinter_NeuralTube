...
%task and results
In this study we generate a single-cell multiome atlas of human neural tube organoids 
...
We confirm the paradigm that enhancers are encoded using heterotypic clusters of 4-5 transcription factor binding sites in a nucleosome depleted region. 
Enhancers encoding anterior-posterior patterning form an exception to this rule, being encoded as
homotypic clusters of homeodomain binding sites.
% TODO: S.A. [some more results? Validation examples? Genetic variants?]
%conclusion
This compendium of enhancer codes provides gene regulatory insight into human development.
%implication
